 ...
 */
public class FastDriverCommandExecutor implements CommandExecutor, NeedsLocalLogs {
	...
	public FastDriverCommandExecutor(DriverService service) {
		Map<String, CommandInfo> additionalCommands = ImmutableMap.<String, CommandInfo>of();
		URL addressOfRemoteServer = service.getUrl();
	...
	public Response superExecute(Command command) throws IOException {
